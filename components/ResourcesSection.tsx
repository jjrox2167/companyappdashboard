...
import { ArrowRightIcon, Book, Download, Share2 } from "lucide-react";
      ...
      <div className="container grid gap-12 md:grid-cols-12 md:gap-8">
        ...
        <div className="md:col-span-7 md:col-start-5 lg:col-start-6">
          <article className="prose prose-sm dark:prose-invert">
            <h1 className="text-primary mb-2 font-bold">
              White Paper: The Complete Guide to Launching Your Startup
            </h1>
            <p>
            ...
            <ul className="bg-accent list-none space-y-2 my-4">
              <li className="flex items-center">
                <ArrowRightIcon className="mr-2 h-5 w-5 text-primary" />
              ...
              <li className="flex items-center">
                <ArrowRightIcon className="mr-2 h-5 w-5 text-primary" />
                <span>3rd level of one-liners: 20 gold coins</span>
              </li>
            </ul>
            <p>
